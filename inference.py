...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        item_sorted = sorted(self.items())
        indexes = [i[1] for i in item_sorted]
        values = [i[0] for i in item_sorted]
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.allPositions:
            beliefz[pos] = self.getObservationProb(observation, gameState.getPacmanPosition(), pos, self.getJailPosition()) * self.beliefs[pos]
        beliefz.normalize()
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(self.numParticles):
            self.particles.append(tuple(ghostPositions[i % len(ghostPositions)]))
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for location in self.particles:
            ...
            for i in range(self.numGhosts):
                weight *= self.getObservationProb(observation[i], gameState.getPacmanPosition(), location[i], self.getJailPosition(i))
